...
- (NSString *)cacheLimitCellTitle {
    const NSInteger cacheLimit = self.cacheLimitValue;
        ...
        case 0: {
            switch (indexPath.row) {
                ...
                case 4:
                    ...
                    const CGFloat sliderWidth = 150.f;
                    const CGFloat sliderOriginY = FLEXFloor((container.size.height - slider.frame.size.height) / 2.0);
                    const CGFloat sliderOriginX = CGRectGetMaxX(container) - sliderWidth - tableView.separatorInset.left;
